<?php
    ...
    if($rows == 0){
        $sql = "INSERT INTO hasranked (user_fk, movie_fk, userLike, userDislike) VALUES ($user_pk, $movie_pk, 1, 0)";
        ...
        if($data['userLike'] == 1){
            ...
            $sql = "UPDATE hasranked SET userLike = 1, userDislike = 0 WHERE user_fk = $user_pk AND movie_fk = $movie_pk";
            mysqli_query($con, $sql);
            header("Location: index.php");
        }
    }
